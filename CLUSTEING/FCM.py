...
# # Datos de ejemplo: X.shape = (n_features, n_samples)
# X = np.random.rand(4, 150)

# # Número de clusters
# c = 3
# m = 1.7  # exponente de fuzzificación

# # Fuzzy C-Means
# cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(
#     X, c, m, error=0.005, maxiter=1000, init=None
# )
...
class_labels = list(df_full[columns[-1]]) # me devuelve las species de las plantas 
df = df_full[features]
